...
def getLOINCbyCode(LOINC):
    ...
    return (data['parameter'][13]['part'][1]['valueCoding']['display'])


print(getLOINCbyCode(f'10840-7'))
...
def print_titles(root):
    Label(root, bg="lavender", text="Client First Name", font="bold 11 underline", ).grid(row=3, column=0)
    Label(root, bg="lavender", text="Client Last Name", font="bold 11 underline").grid(row=3, column=1)
    Label(root, bg="lavender", text="Parameter Value", font="bold 11 underline").grid(row=3, column=2)
    Label(root, bg="lavender", text="Valid Start Time", font="bold 11 underline").grid(row=3, column=3)
    Label(root, bg="lavender", text="Transaction Time", font="bold 11 underline").grid(row=3, column=4)
    Label(root, bg="lavender", text="Valid Data", font="bold 11 underline").grid(
        row=3, column=5)
...
class SampleApp(Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.tk.call('wm', 'SamplePhoto', self._w, img)
        self.changes = False
        self.status = Label(self, bg="lavender", text="Welcome To The Program", bd=1, relief='sunken', anchor='w')
    ...
    def create_menu(self):
        ...
        sub_menu.add_command(label="Change Now Time",
    ...
    def setstatus(self, string):
        self.status.destroy()
        self.status = Label(self, bg="lavender", text=string, bd=1, relief='sunken', anchor='w')
        self.status.pack(side='bottom', fill='x')
    ...
    def show_frame(self, page_name, filename):
        ...
        # frame.configure(width=1400, height=500)
...
class StartPage(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.filename = ""
        self.label = Label(self, bg="lavender", text="Welcome Doctor!", font="none 28 underline", pady=10)
        self.label2 = Label(self, bg="lavender", text="Choose DB File To Open", font="none 20", pady=10)
        self.label3 = Label(self, bg="black", text="", font="none 28 underline", pady=2)
        self.space = Label(self, bg="black", text="", font="none 28 underline", pady=2)
        self.label.grid(row=0, columnspan=3, padx=100)
        self.label3.grid(row=1, columnspan=3, padx=100)
        self.label2.grid(row=2, columnspan=3, padx=300)
        self.space.grid(row=3, columnspan=3, padx=300)
        self.choosefile = Button(self, text="Choose File", cursor='hand2')
        self.choosefile.grid(row=4, columnspan=3)
        ...
        self.button1.grid(row=8, columnspan=3, padx=300, pady=10)
    ...
    def opendbfile(self):
        self.filename = filedialog.askopenfilename \
            (title="Select file", filetypes=(("csv files", "*.csv"),
                                             ("all files", "*.*")))
        Label(self, bg="lavender", text=self.filename).grid(row=5, column=0, pady=10, padx=300)
...
class Page1(Frame):
    ...
    def __init__(self, parent, controller):
        Frame.__init__(self, parent)
        self.controller = controller
        Label(self, bg="lavender", text="Search Client", font="none 32 underline").grid(row=0, columnspan=6, pady=10,
                                                                                        padx=200)
        self.label = []
        self.selector = []
...
class Page2(Frame):
    ...
    def __init__(self, parent, controller):
        Frame.__init__(self, parent)
        self.controller = controller
        Label(self, bg="lavender", text="Get Data By Date", font="none 32 underline"). \
            grid(row=0, columnspan=4, pady=10, padx=200)
        self.label = []
        self.selector = []
...
class Page3(Frame):
    ...
    def __init__(self, parent, controller):
        Frame.__init__(self, parent)
        self.controller = controller
        Label(self, bg="lavender", text="Get Client History", font="none 32 underline"). \
            grid(row=0, columnspan=4, pady=10, padx=200)
        self.label = []
        self.selector = []
        self.entry_1 = MyEntry(self, 'First Name', 1, 0, 10)
...
class Page4(Frame):
    ...
    def __init__(self, parent, controller):
        Frame.__init__(self, parent)
        self.controller = controller
        Label(self, bg="lavender", text="Delete Client Data's", font="none 32 underline"). \
            grid(row=0, columnspan=4, pady=10, padx=200)
        self.label = []
        self.selector = []
        self.entry_1 = MyEntry(self, 'First Name', 1, 0, 10)
    ...
    def send_query(self, fname, lname, param, time):
        ...
        if res:
            ...
            tmplb = []
            for j in range(5):
                lb = Label(self, bg="lavender", text="------------------------")
...
class Page5(Frame):
    ...
    def __init__(self, parent, controller):
        Frame.__init__(self, parent)
        self.controller = controller
        Label(self, bg="lavender", text="Add New Client", font="none 32 underline"). \
            grid(row=0, columnspan=4, pady=10, padx=200)
        self.label = []
        self.selector = []
        self.entry_1 = MyEntry(self, 'First Name', 1, 0, 10)
...
class Page6(Frame):
    ...
    def __init__(self, parent, controller):
        Frame.__init__(self, parent)
        self.controller = controller
        Label(self, bg="lavender", text="Update Client Data's", font="none 32 underline"). \
            grid(row=0, columnspan=4, pady=10, padx=200)
        self.label = []
        self.selector = []
        self.entry_1 = MyEntry(self, 'First Name', 1, 0, 10)
...
class Page7(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.filename = ""
        Label(self, bg="lavender", text="Open New DB File", font="none 32 underline"). \
            grid(row=0, columnspan=4, pady=10, padx=200)
    ...
    def clicktoopen(self, event):
        self.filename = filedialog.askopenfilename \
            (title="Select file", filetypes=(("csv files", "*.csv"),
                                             ("all files", "*.*")))
        Label(self, bg="lavender", text=self.filename).grid(row=2, column=0, columnspan=2,
                                                            pady=10)
        self.openfile()
    ...
    def openfile(self):
        ...
        for line in data:
            ...
            tmp = Label(self.rowFrame, bg="lavender", text=txt)
...
class Page8(Frame):
    ...
    def __init__(self, parent, controller):
        Frame.__init__(self, parent)
        self.controller = controller
        Label(self, bg="lavender", text="ReadMe", font="none 32 underline"). \
            grid(row=0, column=5, pady=10, padx=200)
        Label(self, bg="lavender", text="This Program Created By Ola Bannan", font="none 22"). \
            grid(row=1, column=5, pady=10, padx=200)
        Label(self, bg="lavender", text="eMail: ola.bannan@hotmail.com", font="none 20"). \
            grid(row=3, column=5, pady=10, padx=200)
...
class Page9(Frame):
    ...
    def __init__(self, parent, controller):
        Frame.__init__(self, parent)
        self.controller = controller
        Label(self, bg="lavender", text="Change Now Time", font="none 32 underline"). \
            grid(row=0, columnspan=4, pady=10, padx=200)
